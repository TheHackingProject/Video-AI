...
import {
  BRANCH_FLOW_BODY,
  BRANCH_FLOW_BODY_CPS,
  BRANCH_FLOW_BODY_START_FRAME,
  BRANCH_FLOW_FROM_LOCAL,
  BRANCH_FLOW_NODE_DELAY,
  BRANCH_FLOW_TITLE,
  BRANCH_FLOW_TITLE_REVEAL_DURATION,
  BRANCH_FLOWCHART_START_FRAME,
  CTA_SUBTITLE,
  CTA_SUB_START_FRAME,
  CTA_SUB_CPS,
  CTA_TITLE,
  ...
  PARALLEL_BODY,
  PARALLEL_BODY_CPS,
  PARALLEL_BODY_START_FRAME,
  PARALLEL_TITLE,
  PARALLEL_TITLE_REVEAL_DURATION,
  PREMOUNT_FRAMES,
  RECAP_CPS,
  RECAP_TEXT,
  SCENE_DURATIONS,
...
export const Pilot04Branch: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: bgGradient }}>
      ...
      <Sequence
        from={FRAME.parallelConcept}
        durationInFrames={SCENE_DURATIONS.parallelConcept}
        premountFor={PREMOUNT_FRAMES}
      >
        <Serie01SceneShell
          sceneNumber={3}
        ...
        >
          <div style={narrationBoxStyle}>
            <TextReveal
              text={PARALLEL_TITLE}
              startFrame={0}
              duration={PARALLEL_TITLE_REVEAL_DURATION}
              theme={solarTheme}
            ...
            <div style={{ marginTop: 20, minHeight: 120 }}>
              <Typewriter
                text={PARALLEL_BODY}
                startFrame={PARALLEL_BODY_START_FRAME}
                charsPerSecond={PARALLEL_BODY_CPS}
                theme={solarTheme}
                fontSize={22}
                color={tc.textMuted}
                showCursor={false}
      ...
      <Sequence
        from={FRAME.branchFlowConcept}
        durationInFrames={SCENE_DURATIONS.branchFlowConcept}
        premountFor={PREMOUNT_FRAMES}
      >
        <Serie01SceneShell
          sceneNumber={4}
          ...
          >
            <div style={{ width: "100%", flexShrink: 0 }}>
              <div style={{ ...narrationBoxStyle, textAlign: "center" }}>
                <TextReveal
                  text={BRANCH_FLOW_TITLE}
                  startFrame={0}
                  duration={BRANCH_FLOW_TITLE_REVEAL_DURATION}
                  theme={solarTheme}
                  fontSize={solarTheme.fontSizes.xxl}
                  color={tc.text}
                  direction="left"
                ...
                <div style={{ marginTop: 18, minHeight: 88 }}>
                  <Typewriter
                    text={BRANCH_FLOW_BODY}
                    startFrame={BRANCH_FLOW_BODY_START_FRAME}
                    charsPerSecond={BRANCH_FLOW_BODY_CPS}
                    theme={solarTheme}
                    fontSize={22}
                    color={tc.textMuted}
                    showCursor={false}
              ...
              >
                <FadeIn
                  startFrame={BRANCH_FLOW_FROM_LOCAL}
                  durationInFrames={16}
                  translateY={8}
                >
                  <FlowChart
                    nodes={[
                      ...
                      },
                      {
                        id: "3",
                        label: "Commits",
                        subtitle: "sans toucher main",
                        icon: "▸",
                        color: tc.accent,
                      },
                    ]}
                    startFrame={BRANCH_FLOWCHART_START_FRAME}
                    nodeDelay={BRANCH_FLOW_NODE_DELAY}
