...
import {
  ...
  HOOK_TEXT,
  INTEGRATION_BODY,
  INTEGRATION_BODY_CPS,
  INTEGRATION_BODY_START_FRAME,
  INTEGRATION_TITLE,
  INTEGRATION_TITLE_REVEAL_DURATION,
  MERGE_FLOW_BODY,
  MERGE_FLOW_BODY_CPS,
  MERGE_FLOW_BODY_START_FRAME,
  MERGE_FLOW_FROM_LOCAL,
  MERGE_FLOW_NODE_DELAY,
  MERGE_FLOW_TITLE,
  MERGE_FLOW_TITLE_REVEAL_DURATION,
  MERGE_FLOWCHART_START_FRAME,
  PREMOUNT_FRAMES,
  RECAP_CPS,
  RECAP_TEXT,
  SCENE_DURATIONS,
...
export const Pilot05Merge: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: bgGradient }}>
      ...
      <Sequence
        from={FRAME.integrationConcept}
        durationInFrames={SCENE_DURATIONS.integrationConcept}
        premountFor={PREMOUNT_FRAMES}
      >
        <Serie01SceneShell
          sceneNumber={3}
        ...
        >
          <div style={narrationBoxStyle}>
            <TextReveal
              text={INTEGRATION_TITLE}
              startFrame={0}
              duration={INTEGRATION_TITLE_REVEAL_DURATION}
              theme={solarTheme}
            ...
            <div style={{ marginTop: 20, minHeight: 120 }}>
              <Typewriter
                text={INTEGRATION_BODY}
                startFrame={INTEGRATION_BODY_START_FRAME}
                charsPerSecond={INTEGRATION_BODY_CPS}
                theme={solarTheme}
                fontSize={22}
                color={tc.textMuted}
                showCursor={false}
      ...
      <Sequence
        from={FRAME.mergeFlowConcept}
        durationInFrames={SCENE_DURATIONS.mergeFlowConcept}
        premountFor={PREMOUNT_FRAMES}
      >
        <Serie01SceneShell
          sceneNumber={4}
          ...
          >
            <div style={{ width: "100%", flexShrink: 0 }}>
              <div style={{ ...narrationBoxStyle, textAlign: "center" }}>
                <TextReveal
                  text={MERGE_FLOW_TITLE}
                  startFrame={0}
                  duration={MERGE_FLOW_TITLE_REVEAL_DURATION}
                  theme={solarTheme}
                  fontSize={solarTheme.fontSizes.xxl}
                  color={tc.text}
                  direction="left"
                ...
                <div style={{ marginTop: 18, minHeight: 88 }}>
                  <Typewriter
                    text={MERGE_FLOW_BODY}
                    startFrame={MERGE_FLOW_BODY_START_FRAME}
                    charsPerSecond={MERGE_FLOW_BODY_CPS}
                    theme={solarTheme}
                    fontSize={22}
                    color={tc.textMuted}
                    showCursor={false}
              ...
              >
                <FadeIn
                  startFrame={MERGE_FLOW_FROM_LOCAL}
                  durationInFrames={16}
                  translateY={8}
                >
                  <FlowChart
                    nodes={[
                      ...
                      },
                      {
                        id: "3",
                        label: "Après merge",
                        subtitle: "historique unifié",
                        icon: "▸",
                        color: tc.accent,
                      },
                    ]}
                    startFrame={MERGE_FLOWCHART_START_FRAME}
                    nodeDelay={MERGE_FLOW_NODE_DELAY}
