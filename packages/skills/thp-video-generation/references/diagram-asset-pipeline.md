...
2. Generate SVG (or PNG) into `apps/remotion/public/diagrams/<slug>/` — default tooling: `bunx @mermaid-js/mermaid-cli` (see `video-ai-development` §03b). Optional themed/batch: **pretty-mermaid** from skills.sh (see `packages/skills/README.md`).
