...
export const FPS = 30;
/** Total frames; must equal sum of `SCENES.*.duration` (Studio + `demoShowcaseDuration`). */
export const DEMO_DURATION = 940;

export const SCENES = {
	intro: { from: 0, duration: 150 },
	text: { from: 150, duration: 150 },
	code: { from: 300, duration: 220 },
	crypto: { from: 520, duration: 180 },
	outro: { from: 700, duration: 240 },
} as const;
