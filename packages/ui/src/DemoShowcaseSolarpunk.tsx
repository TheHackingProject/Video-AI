...
import {
	...
	FPS,
	SCENES,
} from "./lib/remotion/demo-showcase/config";
...
function TextDemoScene() {
	...
	return (
		<FadeSlide direction="bottom" distance={40} delay={2}>
			<AbsoluteFill
				style={{
...
const terminalLines = [
	{ type: "command" as const, text: "eco init sustainable-city" },
	{
		...
		text: "🌱 Initializing green infrastructure...",
		delay: 20,
	},
...
const diffShowcaseLines = [
	{ type: "unchanged" as const, content: "async function ship() {" },
	{ type: "removed" as const, content: "  return manual.deploy(); // legacy" },
	{
		type: "added" as const,
		content: "  return pipeline.trigger(); // durable",
	},
		...
		<FadeSlide direction="bottom" distance={40} delay={2}>
			...
			>
				...
				>
					...
					<DiffView
						lines={diffShowcaseLines}
						title="pipeline.ts — review"
						startFrame={110}
						lineDelay={6}
						fontSize={13}
						theme={solarTheme}
...
export const DemoShowcaseSolarpunk = (): React.ReactElement => {
	return (
		<AbsoluteFill style={{ backgroundColor: COLORS.background }}>
			...
			<Sequence
				from={SCENES.crypto.from}
				durationInFrames={SCENES.crypto.duration}
			>
				<CryptoDemoScene />
			</Sequence>
